 ...
 */
public class MyFourFragment extends BaseFragment {
    ...
    public static BaseFragment newInstance() {
        MyFourFragment baseFragment = new MyFourFragment();
    ...
    public int getPageBgColor() {
        return ContextCompat.getColor(getContext(), R.color.color_ffff00);
    }
