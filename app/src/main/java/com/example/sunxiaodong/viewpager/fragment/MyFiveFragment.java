 ...
 */
public class MyFiveFragment extends BaseFragment {
    ...
    public static BaseFragment newInstance() {
        MyFiveFragment baseFragment = new MyFiveFragment();
    ...
    public int getPageBgColor() {
        return ContextCompat.getColor(getContext(), R.color.color_8e35ef);
    }
